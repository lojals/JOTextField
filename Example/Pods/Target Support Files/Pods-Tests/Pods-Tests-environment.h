...
// JOTextField
#define COCOAPODS_POD_AVAILABLE_JOTextField
#define COCOAPODS_VERSION_MAJOR_JOTextField 0
#define COCOAPODS_VERSION_MINOR_JOTextField 1
#define COCOAPODS_VERSION_PATCH_JOTextField 0
